...
if __name__ == "__main__":
    ...
    candidates_df["Exoplanet_Type"] = candidates_df.apply(classify_exoplanet_type, axis=1)
    
    # Display results
    print("Sample Classifications:")
    print("=" * 80)
    result_columns = ['koi_prad', 'koi_teq', 'Exoplanet_Type']
    print(candidates_df[result_columns].head(10).to_string(index=False))
    
    print("\n" + "=" * 80)
    print("Type Distribution:")
    print(candidates_df['Exoplanet_Type'].value_counts())
    
    print("\n" + "=" * 80)
    print("Summary Statistics:")
    print(f"Total candidates: {len(candidates_df)}")
    print(f"Unique types found: {candidates_df['Exoplanet_Type'].nunique()}")
